...
public class ModEnchantments {
    public static final RegistryKey<Enchantment> ANIMALS_ENCHANTMENT = of("animals_enchantment");

    public static void bootstrap(Registerable<Enchantment> registry) {
        RegistryEntryLookup<DamageType> damageTypeLookup = registry.getRegistryLookup(RegistryKeys.DAMAGE_TYPE);
        RegistryEntryLookup<Enchantment> enchantmentLookup = registry.getRegistryLookup(RegistryKeys.ENCHANTMENT);
        RegistryEntryLookup<Item> itemLookup = registry.getRegistryLookup(RegistryKeys.ITEM);
        RegistryEntryLookup<Block> blockLookup = registry.getRegistryLookup(RegistryKeys.BLOCK);
